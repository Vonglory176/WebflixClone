export default function RightArrowSVG() {
    return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" color="none" xmlns="http://www.w3.org/2000/svg" data-mirrorinrtl="true" className="default-ltr-cache-4z3qvp e1svuwfo1" data-name="ChevronRight" aria-hidden="true">
